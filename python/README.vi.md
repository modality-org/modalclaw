...
Gói Python đồng hành cho [ModalClaw](https://github.com/modality-org/modalclaw) — gọi công cụ dựa trên LangGraph cho thực thi agent LLM nhất quán.
...
| Tính năng | Rust ModalClaw | modalclaw-tools |
|---------|---------------|----------------|
...
Dùng **Rust ModalClaw** cho triển khai biên (edge) trong sản phẩm. Dùng **modalclaw-tools** khi cần đảm bảo tính nhất quán gọi công cụ hoặc tích hợp hệ sinh thái Python.
