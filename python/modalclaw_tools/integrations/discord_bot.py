"""
Discord bot integration for ModalClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by ModalClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install modalclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"ModalClaw Discord Bot ready: {self.client.user}")
