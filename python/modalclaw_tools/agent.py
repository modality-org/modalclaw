...
SYSTEM_PROMPT = """You are ModalClaw, an AI assistant with tool access. Use tools to accomplish tasks.
...
def create_agent(
    ...
    """
    Create a ModalClaw agent with LangGraph-based tool calling.
