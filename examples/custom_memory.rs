//! Example: Implementing a custom Memory backend for ModalClaw
//!
...
// ── Re-define the trait types (in your app, import from modalclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 ModalClaw Memory Demo — InMemoryBackend\n");
