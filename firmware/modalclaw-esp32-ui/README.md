# ModalClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for ModalClaw edge scenarios on ESP32.
...
```bash
cd firmware/modalclaw-esp32-ui
cargo build --release
...
3. Connect UI state with ModalClaw edge/runtime messaging
...
- [ModalClaw Hardware Design](../../docs/hardware-peripherals-design.md)
