# ModalClaw Trademark Policy

**Effective date:** February 2026  
**Maintained by:** ModalClaw Labs

---

## Our Trademarks

The following are trademarks of ModalClaw Labs:

- **ModalClaw** (word mark)
- **modality-org** (organization name)
- The ModalClaw logo and associated visual identity

These marks identify the official ModalClaw project and distinguish it from
...
The **only** official ModalClaw repository is:

> https://github.com/modality-org/modalclaw

Any other repository, organization, domain, or product claiming to be
"ModalClaw" or implying affiliation with ModalClaw Labs is unauthorized and
may constitute trademark infringement.

**Known unauthorized forks:**
- `openagen/modalclaw` — not affiliated with ModalClaw Labs

If you encounter an unauthorized use, please report it by opening an issue
at https://github.com/modality-org/modalclaw/issues.

---

## Permitted Uses

You **may** use the ModalClaw name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   ModalClaw, provided it is clear your project is not the official ModalClaw.

2. **Descriptive reference** — referring to ModalClaw in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of ModalClaw"
...
You **may not** use the ModalClaw name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by ModalClaw Labs.

2. **Cause brand confusion** — use "ModalClaw" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official ModalClaw project.

4. **Misrepresent origin** — remove or obscure attribution to ModalClaw Labs
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from ModalClaw Labs.
...
you fork ModalClaw, you must:

- Clearly state your project is a fork of ModalClaw
- Link back to the official repository
- Not use "ModalClaw" as the primary name of your fork
...
Contributors to the official ModalClaw repository are protected under the
...
If you believe someone is infringing ModalClaw trademarks:

1. Open an issue at https://github.com/modality-org/modalclaw/issues
...
ModalClaw Labs reserves the right to update this policy at any time. Changes
...
this policy governs use of the ModalClaw name and brand.*
