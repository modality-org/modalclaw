...
Options:
    ...
    --repo OWNER/NAME   Repository (default: modality-org/modalclaw)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="modality-org/modalclaw",
        help="Repository in OWNER/NAME format (default: modality-org/modalclaw)",
    )
