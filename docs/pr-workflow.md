# ModalClaw PR Workflow (High-Volume Collaboration)

This document defines how ModalClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to ModalClaw/project-native labels.
...
- Confirm any required identity-like wording uses ModalClaw/project-native terminology.
