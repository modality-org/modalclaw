...
## Problem
ModalClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/modalclaw/audit.key"
...
modalclaw audit --user @alice

# Show all high-risk commands
modalclaw audit --risk high

# Show violations from last 24 hours
modalclaw audit --since 24h --violations-only

# Export to JSON for analysis
modalclaw audit --format json --output audit.json
