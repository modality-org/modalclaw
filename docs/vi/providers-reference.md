# Tài liệu tham khảo Providers — ModalClaw
...
3. Biến môi trường dự phòng chung: `MODALCLAW_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, ModalClaw gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, ModalClaw trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `modalclaw models refresh --provider nvidia`
