...
Cách cài đặt và khởi tạo ModalClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài ModalClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image ModalClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.modalclaw-docker`.
