...
| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `modalclaw onboard --api-key sk-... --provider openrouter` |
| I want guided prompts | `modalclaw onboard --interactive` |
| Config exists, just fix channels | `modalclaw onboard --channels-only` |
| Config exists, I intentionally want full overwrite | `modalclaw onboard --force` |
| Using subscription auth | See [Subscription Auth](../../README.md#subscription-auth-openai-codex--claude-code) |

## Onboarding and Validation

- Quick onboarding: `modalclaw onboard --api-key "sk-..." --provider openrouter`
- Interactive onboarding: `modalclaw onboard --interactive`
...
- Validate environment: `modalclaw status` + `modalclaw doctor`
