...
ModalClaw supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current ModalClaw provider behavior.

## Overview

ModalClaw supports these Z.AI aliases and endpoints out of the box:
...
### Test with ModalClaw CLI

```bash
# Test agent directly
echo "Hello" | modalclaw agent
