...
|---------|-----------|--------------|--------|
| **Base ModalClaw** | 3.4MB | <5MB | ✅ Current |
...
| Hardware | RAM | ModalClaw (base) | ModalClaw (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, ModalClaw uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### ModalClaw's Core Promise: Swap Anything
