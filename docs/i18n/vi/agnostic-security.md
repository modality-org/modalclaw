...
|---------|-----------|--------------|--------|
| **ModalClaw cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | ModalClaw (cơ bản) | ModalClaw (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, ModalClaw chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của ModalClaw: hoán đổi bất kỳ thứ gì
