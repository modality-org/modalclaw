...
const SNAPSHOT_HEADER: &str = "# 🧠 ModalClaw Memory Snapshot\n\n\
    > Auto-generated by ModalClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 ModalClaw Memory Snapshot

> Auto-generated by ModalClaw.
...
I am ModalClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 ModalClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
