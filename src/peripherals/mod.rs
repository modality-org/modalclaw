...
/// Handle `modalclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: modalclaw peripheral add <board> <path>");
                println!("  Example: modalclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
