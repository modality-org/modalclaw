...
const OTP_ISSUER: &str = "ModalClaw";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(modalclaw_dir);
...
pub fn secret_file_path(modalclaw_dir: &Path) -> PathBuf {
    modalclaw_dir.join(OTP_SECRET_FILE)
}
