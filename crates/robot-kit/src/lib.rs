//! # ModalClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with ModalClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  ModalClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use modalclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of ModalClaw. It defines its own
//! `Tool` trait that is compatible with ModalClaw's but doesn't require it.
//!
//! ## Safety
//!
