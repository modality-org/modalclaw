...
This guide covers testing the Telegram channel integration for ModalClaw.
...
Solution: Check user allowlist
  ...
  4. Run: modalclaw onboard --channels-only
```
...
# 3. Monitor logs
RUST_LOG=info modalclaw daemon
...
| ---------------------- | ---------- | -------------------------------- |
| Health check time      | <5s        | `time modalclaw channel doctor`   |
...
```bash
# Maximum logging
RUST_LOG=trace modalclaw channel start
...
# Validate config
cat ~/.modalclaw/config.toml | grep -A 3 "\[channels_config.telegram\]"
```
...
- [ModalClaw Main README](README.md)
- [Contributing Guide](CONTRIBUTING.md)
- [Issue Tracker](https://github.com/theonlyhennygod/modalclaw/issues)
