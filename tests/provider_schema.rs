...
use modalclaw::providers::compatible::AuthStyle;
use modalclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use modalclaw::providers::compatible::OpenAiCompatibleProvider;
